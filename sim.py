...
def mode_trajectory_tracking(cf, args):
    ...
    while True:
        ...
        if loop_start - start_time < args.transition_timeout:
            send_hover_packet(cf, args.height)
        else:
            send_learned_policy_packet(cf)

        elapsed = time.time() - loop_start
        sleep_time = (1/100) - elapsed
        if sleep_time > 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trajectory-interval', default=15, type=float, help="Interval of the trajectory")
